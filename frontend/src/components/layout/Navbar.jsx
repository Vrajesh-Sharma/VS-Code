  ...
  return (
    <nav className="fixed top-0 left-0 w-full h-20 glass-panel border-b border-white/5 z-50 flex items-center justify-between px-6 lg:px-12 backdrop-blur-xl bg-background/40">
      ...
      <div className="flex items-center gap-4">
        ...
        <button className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-muted-foreground hover:text-foreground hover:bg-white/10 transition-colors">
